...
for tokens, labels in zip(person_test_tokens, person_test_labels):
    ...
    common_items_count = len(set(predicted_persons) & set(actual_persons))
    correct_person_count += common_items_count

print(f"Accuracy in predicting person is {correct_person_count/person_count}")
